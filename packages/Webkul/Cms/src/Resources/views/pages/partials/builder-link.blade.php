...
<div class="cms-builder-link-block mb-4 rounded-lg border border-gray-200 p-3 dark:border-gray-800" data-cms-builder-link>
    ...
    <div class="cms-builder-field-group rounded-lg border border-gray-100 bg-gray-50/80 p-3 dark:border-gray-800 dark:bg-gray-900/40">
        <p class="cms-builder-field-group__title">@lang('cms::app.pages.builder.groups.link_settings')</p>
        ...
        @foreach ($locales as $locale => $localeLabel)
            ...
            >
                @include('cms::components.builder-field-label', [
                    'label' => __('cms::app.links.form.name'),
                    'hint' => __('cms::app.pages.builder.hints.link_name'),
                    'required' => $locale === 'en',
                ])
                <input
                    type="text"
        ...
        <div class="mt-4 border-t border-gray-100 pt-4 dark:border-gray-800">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <div>
                    @include('cms::components.builder-field-label', [
                        'label' => 'URL',
                        'hint' => __('cms::app.pages.builder.hints.link_url'),
                        'required' => true,
                    ])
                    <input
                        type="text"
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        @include('cms::components.builder-field-label', [
                            'label' => __('cms::app.links.form.target'),
                            'hint' => __('cms::app.pages.builder.hints.link_target'),
                        ])
                    ...
                    <div>
                        @include('cms::components.builder-field-label', [
                            'label' => __('cms::app.links.form.type'),
                            'hint' => __('cms::app.pages.builder.hints.link_type'),
                        ])
            ...
            <div class="mt-3 grid gap-3 md:grid-cols-3">
                <div>
                    @include('cms::components.builder-field-label', [
                        'label' => __('cms::app.links.form.icon'),
                        'hint' => __('cms::app.pages.builder.hints.link_icon'),
                    ])
                    <input
                        type="text"
                ...
                <div>
                    @include('cms::components.builder-field-label', [
                        ...
                        'hint' => __('cms::app.pages.builder.hints.link_order'),
                    ])
                    <input
                        type="number"
                ...
                <div class="flex items-end gap-2 pb-1">
                    <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                        ...
                        @include('cms::components.builder-field-label', [
                            ...
                            'hint' => __('cms::app.pages.builder.hints.link_active'),
                            'inline' => true,
                        ])
                    </label>
                </div>
